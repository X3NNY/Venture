...
const runCopy = () => {
    return copy({
        targets: [
            ...
            {
                src: 'src/module/layout/dynamic/algo_wasm_priorityqueue.wasm',
                dest: config.copyPath
            },
            {
...
export default {
    ...
    plugins: [
        ...
        // 压缩混淆代码
		terser({ format: { comments: false, beautify: false }, mangle: false, compress: false }),
        // 复制依赖文件
        copy({
            targets: [
                {
    ...
    external: ['src/module/layout/dynamic/algo_wasm_priorityqueue.wasm']
};